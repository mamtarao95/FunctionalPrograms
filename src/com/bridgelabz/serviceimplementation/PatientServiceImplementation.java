...
public class PatientServiceImplementation implements PatientService{
	...
	File patientFileLoc = new File(
			"/home/administrator/mamta-workspace/ClinicManagement/src/com/bridgelabz/files/Patient.json");
	...
	public void popularDoctor() throws JsonParseException, JsonMappingException, IOException {
		System.out.println("Popular Doctor of the clinic.. :");
		System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(findPopular()));
